...
Usage:
    python 01a_generate_sample_data.py --industry "Healthcare" --usecase "Patient appointment scheduling"
    python 01a_generate_sample_data.py  # Interactive mode
